...
BACKEND_URL = "https://deaa8412-73d0-43db-81cf-cae3dfb83044.preview.emergentagent.com/api"
...
class ElvaBackendTester:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://deaa8412-73d0-43db-81cf-cae3dfb83044.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://deaa8412-73d0-43db-81cf-cae3dfb83044.preview.emergentagent.com/api/gmail/callback"
    ...
    def run_all_tests(self):
        ...
        print("🔗 REDIRECT URI: https://deaa8412-73d0-43db-81cf-cae3dfb83044.preview.emergentagent.com/api/gmail/callback")
